...
пропущенные пробелы, неиспользованную переменную name_string,
...
не все строчки были на своих местах и иногда были слишком длинными - все эти недочеты несложно исправить. 
